      ...
      <div class="columns">
        ...
        <div class="column is-9">
          <div class="box content" :class="{fetching: isFetching, 'has-error': error}">
            ...
            <div v-if="!isFetching">
              <div class="activity-lenght">Currently {{ activityLength }} activities</div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      watchedAppName: "Activity Planner by Mano Fabian",
      isFetching: false,
      error: null,
      user: {},
      activities,
  ...
  computed: {
    filteredActivities() {
      ...
      return Object.values(this.activities).filter(activity => condition(activity.progress));
    },
    fullAppname() {
